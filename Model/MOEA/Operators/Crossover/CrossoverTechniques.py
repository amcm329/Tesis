...
def n_points_crossover(chromosome_a,chromosome_b,options):
    ...
    how_many_points = options[0]
    crossover_probability = options[1]    
...
def real_crossover(chromosome_a,chromosome_b,additional_options):
    pass

#Implement all the other crossovers

#a = [1,2,3,4,5]
#b = [6,7,8,9,10]

#print uniform_crossover(a,b,0.5)
#print n_points_crossover(a,b,1,0.6)
