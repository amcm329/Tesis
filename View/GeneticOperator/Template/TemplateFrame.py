...
class TemplateFrame(tk.Frame):
      ...
      def __init__(self, parent,name,options):
          ...
          self.title_label = tk.Label(self, text = self.__title)
      ...
      def get_information(self):
          ...
          return { self.class_name + "_class":selected_class,
                   self.class_name + "_options":selected_options }
