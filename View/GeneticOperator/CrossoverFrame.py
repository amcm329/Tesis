...
class CrossoverFrame(TemplateFrame):
      ...
      def get_information(self):
          crossover_information = TemplateFrame.get_information(self)
          crossover_information["probability_{0}_general".format(self.class_name)] = self.__probability_entry.get()
